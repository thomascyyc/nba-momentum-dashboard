#!/usr/bin/env python3
"""
Fetch historical NBA data for ML pipeline.

Downloads player game logs, advanced stats, and team defense stats from
Basketball Reference. Saves to data/ as parquet files, then builds the
...
Usage:
    ...
    python scripts/fetch_historical_data.py --current    # include 2025-26 in-progress
"""
...
from src.data.nba_api_client import HISTORICAL_SEASONS, CURRENT_SEASON
...
def main():
    ...
    parser.add_argument(
        ...
        help=f"Also fetch current in-progress season ({CURRENT_SEASON})"
    )
    ...
    for season in seasons:
        ...
        # Step 2: Advanced player stats — may fail
        ...
        # Step 3: Team opponent stats — may fail
